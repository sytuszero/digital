...
const FLIP_FLOPS = {
    SR_HIGH: {
        ...
        symbolSVG: `<svg class="flipflop-svg" viewBox="0 0 800 500" style="width:100%; max-width:800px; height:auto;">
            <!-- Top NOR Gate -->
...
function selectFlipFlop(ffKey) {
    ...
    document.getElementById('flipflop-svg-wrapper').innerHTML = ff.symbolSVG;
